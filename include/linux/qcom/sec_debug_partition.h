...
#define SEC_DEBUG_EXTRA_INFO_SIZE		(SECTOR_UNIT_SIZE)
#define SEC_DEBUG_RESET_KLOG_OFFSET		(1*1024*1024)
#define SEC_DEBUG_RESET_KLOG_SIZE		(0x200000)		/* 2MB */
#define SEC_DEBUG_RESET_SUMMARY_OFFSET		(SEC_DEBUG_RESET_KLOG_OFFSET + SEC_DEBUG_RESET_KLOG_SIZE) /* 3*1024*1024*/
